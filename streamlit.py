...
<style>
    ...
    * {
    ...
    .profile-pic {
        ...
        height: 120px;
        border-radius: 50%;
        border: 4px solid #e6187f;
        object-fit: cover;
        margin: 0;
        display: block;
        background: white;
        box-shadow: 0 8px 30px rgba(230, 24, 127, 0.3);
        transition: transform 0.3s ease, box-shadow 0.3s ease;
    }

    .profile-pic:hover {
        transform: scale(1.05);
        box-shadow: 0 12px 40px rgba(230, 24, 127, 0.4);
    }

    /* Style Streamlit images as profile pics */
    .profile-container img {
        border-radius: 50% !important;
        border: 4px solid #e6187f !important;
        box-shadow: 0 8px 30px rgba(230, 24, 127, 0.3) !important;
    ...
    .profile-container img:hover {
        ...
        box-shadow: 0 12px 40px rgba(230, 24, 127, 0.4) !important;
    }
